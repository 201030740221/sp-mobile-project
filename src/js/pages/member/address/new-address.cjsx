...
PageAddress = React.createClass
    mixins: [MemberCheckLoginMixin, LinkedStateMixin, liteFlux.mixins.storeMixin('newAddress', 'region')]
    ...
    render: ->
        ...
        <Page navbar-through toolbar-through className="new-address">
            ...
            <PageContent className="bg-white">
                <div className="new-address">
                    ...
                    <div className="form u-mt-50">
                        ...
                        <Panel>
                            <Button onTap={@save} block  className="u-mt-20">{"保存"}</Button>
                        </Panel>
                    </div>
                </div>
